    ...
    <BackofficeLayout title="Novo Cliente">
      <div className="mx-auto max-w-2xl">
        <div className="mb-6">
          ...
          <p className="text-sm text-[#999]">Preencha os dados do cliente</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div>
              <label className="block text-sm text-[#999]">Nome Completo *</label>
              <input
                type="text"
                required
                value={formData.name}
          ...
          {/* Tipo de Cliente */}
          <div className="space-y-3">
            <h3 className="text-sm font-semibold uppercase tracking-wider text-[#888]">Tipo de Cliente</h3>
            
            <div>
              <label className="block text-sm text-[#999]">Interesse *</label>
              <select
                value={formData.type}

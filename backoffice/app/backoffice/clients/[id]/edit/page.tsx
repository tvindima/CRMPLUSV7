    ...
    async function fetchClient() {
      try {
        ...
        setFormData({
          ...
          client_type: data.client_type || "comprador",
          notas: data.notas || "",
          tags: data.tags || [],
        });
      } catch (err: any) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.detail || errorData.error || 'Erro ao atualizar cliente');
      }
      ...
      router.push(`/backoffice/clients/${clientId}`);
    } catch (err: any) {
  ...
  return (
    <BackofficeLayout title="Editar Cliente">
      <div className="mx-auto max-w-4xl">
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-white">Editar Cliente</h1>
          <p className="text-sm text-[#999]">Atualize os dados do cliente</p>
        </div>
